...
class SoundManager {
  ...
  private loadSounds() {
    ...
    const soundEffects = {
      click: this.createAudio('data:audio/wav;base64,') as HTMLAudioElement,
      
      correct: this.createAudio('data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvGkfCEybvLKOeS8FI3TC7OCRRAoSW7Pl7bBREg1NoOvxu2AUCD6X2PTPMS4FJXfE8d2QQgtTr+ixsWAfBT') as HTMLAudioElement,
      
      wrong: this.createAudio('data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvGkfCEybVLeMeS8FI3TC7OCRRAoSW7Pl7bBREg1NoOvxu2AUCD6X2PTPMS4FJXfE8d2QQgtTr+ixsWAfBT') as HTMLAudioElement,
      
      gameOver: this.createAudio('data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvGkfCEybvLKOeS8FI3TC7OCRRAoSW7Pl7bBREg1NoOvxu2AUCD6X2PTPMS4FJXfE8d2QQgtTr+ixsWAfBT') as HTMLAudioElement,
      
      whoosh: this.createAudio('data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvGkfCEybvLKOeS8FI3TC7OCRRAoSW7Pl7bBREg1NoOvxu2AUCD6X2PTPMS4FJXfE8d2QQgtTr+ixsWAfBT') as HTMLAudioElement
    }
